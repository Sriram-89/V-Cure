    ...
    <div className="flex flex-col gap-6">
      ...
      <section>
        <div className="flex items-center justify-between">
          ...
          <button
            type="button"
            onClick={() => goToStep("health-profile")}
            className="text-xs font-medium text-primary hover:text-primary-700"
          >
            Edit
          </button>
        </div>
        <ReviewRow label="Height" value={`${healthProfile?.heightCm ?? "—"} cm`} />
        <ReviewRow label="Weight" value={`${healthProfile?.weightKg ?? "—"} kg`} />
        <ReviewRow
          label="Blood group"
          value={healthProfile?.bloodGroup?.replace("_", " ") ?? "—"}
        />
      </section>
      ...
      <section>
        <div className="flex items-center justify-between">
          ...
          <button
            type="button"
            onClick={() => goToStep("medical-profile")}
            className="text-xs font-medium text-primary hover:text-primary-700"
          >
            Edit
          </button>
      ...
      <section>
        ...
        <ReviewRow label="Diet" value={LABELS[lifestyle?.dietType ?? ""] ?? "—"} />
      </section>
