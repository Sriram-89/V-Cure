  ...
  return (
    <div className="flex flex-col gap-5">
      ...
      <button
        ...
        disabled={isGoogleLoading || registerMutation.isPending || loginMutation.isPending}
      ...
      <form className="flex flex-col gap-4" onSubmit={handleSubmit(onSubmit)} noValidate>
        {registerMutation.isError || googleError ? (
          ...
          >
            ...
            <span>{googleError || getRegisterErrorMessage(registerMutation.error)}</span>
          </div>
        ) : null}
