  ...
  return (
    <form className="flex flex-col gap-5" onSubmit={handleSubmit(onSubmit)} noValidate>
      <div className="rounded-2xl bg-gray-50 p-4 border border-gray-100 flex items-start gap-2.5 text-xs text-gray-600">
        ...
        <span>
          Lab values help us fine-tune carbohydrate and glycemic guidance. Leave blank if unknown — you can upload your medical report later.
        </span>
      </div>
      ...
      <InputField
        label="Random / Post-Meal Glucose (mg/dL)"
        type="number"
        placeholder="e.g. 145"
      ...
      <div className="pt-1">
        ...
        >
          ...
          I don't know / I'll upload my report
        </button>
      </div>
